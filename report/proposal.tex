...
本次为\textbf{修订重提交}。相比初版，我深入研究了生物医学文献分类领域，理解了MeSH主题词层级体系，重构了项目架构，新增两个高质量全标注基准数据集，并找到利用DeepSeek API（OpenAI兼容格式，\texttt{deepseek-v4}模型）进行批量标注\footnote{Touchent et al., arXiv:2506.20331, 2025}的方法来解决目标数据集标注问题。算法方面，受PGB启发新增了\textbf{图表示学习方法}（node2vec、GCN、GraphSAGE）。本项目不属于任何课程或SRT项目。
