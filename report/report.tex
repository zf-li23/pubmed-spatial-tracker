...
\label{fig:mesh}
\end{figure}
\footnotetext{图片改编自 Lee \& Ho, arXiv:2305.02691, 2023 Figure~1。}
...
\label{fig:tcsteps}
\end{figure}
\footnotetext{图片改编自 Rostam \& Kert\'{e}sz, ACM TIST, 2025, Figure~3。}
...
\label{fig:pretrain}
\end{figure}
\footnotetext{图片改编自 Rostam \& Kert\'{e}sz, ACM TIST, 2025, Figure~4。}
